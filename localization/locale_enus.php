...
/*105*/     SmartEvent::EVENT_AREA_CASTING            => ['When %11$s targets in area are casting', 'Repeat every %s'],
            ...
            SmartEvent::EVENT_AC_WAYPOINT_REACHED     => ['Reaching (%1$d)?waypoint #[b]%1$d[/b]:any waypoint;(%2$d)? on path #[b]%2$d[/b]:;', ''],
            SmartEvent::EVENT_AC_WAYPOINT_ENDED       => ['Ending path on (%1$d)?waypoint #[b]%1$d[/b]:any waypoint;(%2$d)? at path #[b]%2$d[/b]:;', ''],
