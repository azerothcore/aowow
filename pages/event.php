...
class EventPage extends GenericPage
{
    ...
    protected function generateContent()
    {
        ...
        // tab: npcs
        if ($npcIds = DB::World()->selectCol('SELECT id1 as id AS ARRAY_KEY, IF(ec.eventEntry > 0, 1, 0) AS added FROM creature c, game_event_creature ec WHERE ec.guid = c.guid AND ABS(ec.eventEntry) = ?d', $this->eId))
        {
